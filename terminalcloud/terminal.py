...
def start_snapshot(snapshot_id, instance_type=None, temporary=None, name=None, autopause=None, startup_script=None,
    ...
    params = {'snapshot_id': snapshot_id, 'instance_type': instance_type, 'temporary': temporary, 'name': name,
              'autopause': autopause, 'startup_script': startup_script, 'keep_ram': keep_ram}
    response = make_request(call, params)
    return response
...
def snapshot_terminal(container_key, body=None, title=None, readme=None, tags=None, public=None, keep_ram=True):
    call = 'snapshot_terminal'
    params = {'container_key': container_key, 'keep_ram': keep_ram, 'body': body, 'title': title, 'readme': readme,
...
def set_terminal_idle_settings(container_key, triggers=None, action=None):
    ...
    params = {'container_key': container_key, 'triggers': triggers, 'action': action}
    response = make_request(call, params)
    return response
